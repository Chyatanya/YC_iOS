...
- (void)setupWithType:(NSUInteger)type {
    ...
    if (self.storyboard) {
        ...
        self.leftViewController = [LeftSlideTableViewController new];
        self.rightViewController = [LeftSlideTableViewController new];
...
//            UIColor *colorTheme = [UIColor colorWithRed:133.0/255.0 green:193.0/255.0 blue:92.0/255.0 alpha:0.7];
//            self.rootViewCoverColorForLeftView = colorTheme;
